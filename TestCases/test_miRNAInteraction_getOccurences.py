...
class TestDataset(unittest.TestCase):
    ...
    def test_miRNA_Interaction_getOccurences_disease_and_mimat_number(self):
        ...
        mock_response = test_read_all_mirna(disease_name='head and neck squamous cell carcinoma', mimat_number=['MIMAT0000080', 'MIMAT0000095'], occurences=500, sorting="occurences", limit=50)

        # retrieve current API response to request
        api_response = geneInteraction.read_all_mirna(disease_name='head and neck squamous cell carcinoma', mimat_number= ['MIMAT0000080', 'MIMAT0000095'],  occurences=500,  sorting="occurences", limit=50)
    ...
    def test_miRNA_Interaction_getOccurences_disease_and_mimat_number_sorting_asc(self):
        ...
        # retrieve correct database response to request
        mock_response = test_read_all_mirna(disease_name='head and neck squamous cell carcinoma', mimat_number=['MIMAT0000080', 'MIMAT0000095'], occurences=500, limit=50,  sorting="occurences", descending=False)
    ...
    def test_miRNA_Interaction_getOccurences_disease_and_hs_number(self):
        ...
        # retrieve correct database response to request
        mock_response = test_read_all_mirna(disease_name='head and neck squamous cell carcinoma', hs_number=['hsa-miR-24-3p', 'hsa-miR-96-5p'], occurences=500,limit=50)
    ...
    def test_miRNA_Interaction_getOccurences_disease_and_hs_number_sorting_asc(self):
        ...
        # retrieve correct database response to request
        mock_response = test_read_all_mirna(disease_name='head and neck squamous cell carcinoma', hs_number=['hsa-miR-24-3p', 'hsa-miR-96-5p'], occurences=500, limit=50,  sorting="occurences", descending=False)
